...
const EventPage = () => {
  ...
  const eventArr = [
    ...
    {
      eventName: 'BIRTHDAY',
      eventTitle: 'Celebrate Your Special Day in Style with Professional Birthday Organizers',
      eventDescription: "Our creative geniuses excel in designing personalized themes that reflect your personality and interests. From whimsical fairy tales to thrilling adventures, we can transform any concept into a captivating reality. Get ready to be dazzled by our extensive network of talented entertainers. From energetic DJs and live bands to mesmerizing magicians and acrobats, we'll ensure that your guests are thoroughly entertained throughout the event. Indulge your taste buds with our delectable culinary offerings. Whether you desire a gourmet feast, a trendy food truck experience, or a delightful dessert spread, our culinary experts will create a menu that satisfies your cravings and leaves a lasting impression on your guests.",
      eventStartDate: '',
      eventEndDate: '',
      eventImage: 'https://images.pexels.com/photos/16930505/pexels-photo-16930505/free-photo-of-wood-restaurant-vacation-people.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'
    },

    {
      eventName: 'ANNIVERSARY',
      eventTitle: "Celebrate Your Love Story with an Unforgettable Anniversary Celebration",
      eventDescription: "We believe that it's the little details that make a celebration truly memorable. Surprise your partner with heartfelt gestures, such as personalized love notes, photo collages, or a special performance dedicated solely to them. Our team will help you plan these touching surprises that will make your anniversary celebration even more meaningful.From intimate candlelit dinners to grand soirées, we know how to set the stage for a romantic celebration. Our team of designers will transform the venue into a captivating haven, adorned with elegant decorations, soft lighting, and luxurious details, all tailored to your preferred style and theme.",
      eventStartDate: '',
      eventEndDate: '',
      eventImage: 'https://images.pexels.com/photos/2072175/pexels-photo-2072175.jpeg?auto=compress&cs=tinysrgb&w=600'
    },

    {
      eventName: 'CONFERENCE',
      eventTitle: "Ignite Inspiration and Drive Success at Our Remarkable Conference",
      eventDescription: "Engage in interactive sessions designed to foster collaboration and encourage lively discussions. Our panels and workshops cover a wide range of topics, addressing the latest trends, challenges, and opportunities in your industry. Gain practical skills, exchange ideas, and connect with like-minded professionals who share your passion for growth and innovation.Expand your professional network and forge meaningful connections with industry peers, potential collaborators, and mentors. Our conference provides ample networking opportunities, including dedicated networking sessions, cocktail receptions, and informal gatherings. Share experiences, exchange business cards, and build relationships that may open doors to exciting new ventures.",
      eventStartDate: '',
      eventEndDate: '',
      eventImage: 'https://images.pexels.com/photos/1325766/pexels-photo-1325766.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'
    }
  ]
